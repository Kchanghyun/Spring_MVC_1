...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        System.out.println("[Host 편의 조회] " + request.getHeader("Host"));
        ...
        request.getLocales().asIterator() // ko, en_US, en, ko_KR
        ...
        System.out.println("request.getContentType() = " + request.getContentType()); // GET 방식은 Content를 안보내기 때문에 null,
    ...
    private void printEtc(HttpServletRequest request) {
        ...
        System.out.println("[Local 정보]"); // 내 local 정보
